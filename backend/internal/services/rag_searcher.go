...
// RAGSearcher is the narrow interface callers consume from the RAG
// layer. It deliberately avoids
...
//
// The two methods cover the only two things callers care about:
// "does this project have any indexed knowledge?" (gates
...
// main.go calls this once and threads the result to its consumers.
