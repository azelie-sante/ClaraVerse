...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|clara-agent]   Update ${APP_NAME}, extensions, or model catalogs
...
${chalk.bold("Environment Variables:")}
  ...
  CLARAVERSE_URL                   - ClaraVerse instance to log in against (default: http://localhost:3000)
  PI_PACKAGE_DIR                   - Override package directory (for Nix/Guix store paths)
  PI_OFFLINE                       - Disable startup network operations when set to 1/true/yes
  CLARA_SHARE_VIEWER_URL           - Optional web viewer for /share (default: none, prints the gist URL)
  CLARA_MODEL_CATALOG_URL          - Optional model-catalog service for built-in providers (default: none)
